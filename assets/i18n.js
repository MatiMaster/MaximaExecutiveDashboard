...
(function (root) {
  ...
  const STR = {
    es: {
      ...
      fltTitle: 'Filtros', fltActive: '{n} activos', fltNone: 'Sin filtros', fltReset: 'Limpiar',
      fltAll: 'Todos', fltFrom: 'Desde', fltTo: 'Hasta', fltDoc: 'N.º documento', fltDocPh: 'Documento exacto',
      fltEmpty: 'No hay datos para la combinación de filtros seleccionada.',
      fltRep: 'Vendedor', fltClientCat: 'Categoría de cliente', fltSub: 'Subsidiaria', fltLoc: 'Bodega',
      fltCustomer: 'Cliente', fltCType: 'Tipo de cliente', fltCustCat: 'Categoría (ventas)', fltCountry: 'País', fltSeg: 'Segmento',
    ...
    en: {
      ...
      fltTitle: 'Filters', fltActive: '{n} active', fltNone: 'No filters', fltReset: 'Reset',
      fltAll: 'All', fltFrom: 'From', fltTo: 'To', fltDoc: 'Document no.', fltDocPh: 'Exact document',
      fltEmpty: 'No data for the selected filter combination.',
      fltRep: 'Sales Rep', fltClientCat: 'Client Category', fltSub: 'Subsidiary', fltLoc: 'Location',
      fltCustomer: 'Customer', fltCType: 'Customer Type', fltCustCat: 'Customer Category', fltCountry: 'Country', fltSeg: 'Product Segment',
